...
const void Gerenciador_Colisoes::setJogadores(Personagens::Jogador* j1, Personagens::Jogador* j2) {
	jog1 = j1;
	jog2 = j2;
}
...
const void Gerenciador_Colisoes::includeEntidade(Entidade* ent) {
...
const void Gerenciador_Colisoes::removeEntidade(Entidade* ent) {
    if (ent->getId() == 4) {
...
const bool Gerenciador_Colisoes::veriColisao(Entidade* ent1, Entidade* ent2) {
...
const void Gerenciador_Colisoes::verificaObs() {

}

// Implementar após as listas serem criadas
const void Gerenciador_Colisoes::verificaIni() {

}

// Implementar após as listas serem criadas
const void Gerenciador_Colisoes::veriProjetil() {
...
const void Gerenciador_Colisoes::executar() {
    verificaIni();
    verificaObs();
    veriProjetil();
};
